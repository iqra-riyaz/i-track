  ...
  return (
    <div className="min-h-screen relative">
      ...
      >
        ...
        {/* Calendar Tracker Feature Button */}
        <motion.div
          className="flex justify-center mb-8"
          variants={itemVariants}
        >
          <Link href="/calendar" className="px-6 py-3 flex items-center space-x-2 bg-lavender/90 text-white rounded-full shadow-lg shadow-lavender/30 hover:bg-lavender hover:scale-105 transition-all duration-300">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
            </svg>
            <span>Daily Calendar Tracker</span>
            <span className="ml-1 px-2 py-0.5 bg-white/20 rounded-full text-xs font-medium">New!</span>
          </Link>
        </motion.div>
